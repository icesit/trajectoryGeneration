...
Beq = [1;
       ...
       0;
       Vtempx;%11/12
       Aeq(3,:)*sigma_ones(:,1)*abs(fixPoints(2,1)-fixPoints(1,1))/(traTime(1)^2)*(traTime(2)^2)/abs(fixPoints(3,1)-fixPoints(2,1));
       Aeq(4,:)*sigma_ones(:,1)*abs(fixPoints(2,1)-fixPoints(1,1))/(traTime(1)^3)*(traTime(2)^3)/abs(fixPoints(3,1)-fixPoints(2,1))
       ];
...
Beq = [1;
       ...
       0;
       Vtempy;%10/9;
       Aeq(3,:)*sigma_ones(:,2)*abs(fixPoints(2,2)-fixPoints(1,2))/(traTime(1)^2)*(traTime(2)^2)/abs(fixPoints(3,2)-fixPoints(2,2));
       Aeq(4,:)*sigma_ones(:,2)*abs(fixPoints(2,2)-fixPoints(1,2))/(traTime(1)^3)*(traTime(2)^3)/abs(fixPoints(3,2)-fixPoints(2,2))
       ];
